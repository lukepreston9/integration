...
def main():
    ...
    elif not(player_experience == "Yes"):
        print(" ")
        print("No worries! The goal of the game is to "
              "sink your opponents battleship!")
        print(" ")
        print(
            "We will go over the official rules of the game board very soon.")
    ...
    """ The game_board variable holds the string 0 and multiplies that 
    string by 6. While being introduced to the range function that 
    creates 6 rows. Therefore creating a 6x6 game board which 
    is exactly what we want. """

    game_board = (" 0 " * 6)
    list_layout = game_board
    print_board(list_layout)
    print(" ")
    ...
    print(
        "As you can see this is a 6x" + "6 game board, there are 36 different "
                                        "spots you can guess.")
    print(" ")

    print("You will go about guessing by choosing horizontally first, "
          "counting from the bottom left 0.")
    print("From there you will be able to guess vertically, counting from the "
    ...
    print(" ")
    print(
        "But your opponents ship could also be in 3 spots of one of these "
        "even numbered rows vertically: ")
    ...
    # HIT OR MISS EXAMPLE LEVEL CALCULATION
    """This section of the program consists of holding the number of guesses
    the player uses, as well as the area of the game board in which he selects
    where he/she would like to fire in order to hit their opponent."""
    game_board = (" 0 " * 6)
    list_layout = game_board
    print_board(list_layout)
    print(" ")
    num_guesses = 0
    while True:
        horizontal_guess = int(input("Place your horizontal guess here: "))
        vertical_guess = int(input("Place your vertical guess here: "))
        num_guesses = num_guesses + 1
        if (horizontal_guess % 2 == 0 and horizontal_guess < 7) and \
                (vertical_guess % 2 == 0 and vertical_guess < 7):
            print("HIT! Nice Job!")
            print("Guess count: ", num_guesses)
        if (horizontal_guess >= 7 or horizontal_guess % 2 != 0) or \
                (vertical_guess % 2 != 0 and vertical_guess < 7):
